// <copyright file="GoalTrackerActivityMiddleware.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.GoalTracker.Bot
{
    ...
    /// </summary>
    public class GoalTrackerActivityMiddleware : IMiddleware
    {
        /// <summary>
        ...
        /// </summary>
        private readonly ILogger<GoalTrackerActivityMiddleware> logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="GoalTrackerActivityMiddleware"/> class.
        /// </summary>
        /// <param name="options"> A set of key/value application configuration properties.</param>
        /// <param name="logger">Instance to send logs to the Application Insights service.</param>
        /// <param name="localizer">The current cultures' string localizer.</param>
        public GoalTrackerActivityMiddleware(IOptions<GoalTrackerActivityHandlerOptions> options, ILogger<GoalTrackerActivityMiddleware> logger, IStringLocalizer<Strings> localizer)
        {
